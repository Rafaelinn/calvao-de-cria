...
class Player(pygame.sprite.Sprite):
    ...
    def collide_enemy(self):
        ...
        if hits:
            ...
            pygame.mixer.Channel(7).play(pygame.mixer.Sound('soundtrack/dmg.mp3'))
            if self.game.hp == 0:
                pygame.mixer.Channel(0).stop()
                pygame.mixer.Channel(3).set_volume(0.4)
                pygame.mixer.Channel(3).play(pygame.mixer.Sound('soundtrack/damage.mp3'))
                pygame.mixer.Channel(6).set_volume(0.3)
                pygame.mixer.Channel(6).play(pygame.mixer.Sound('soundtrack/atum.mp3'))
                self.kill()
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.max_travel = random.randint(20, 20)
...
class Block2(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.terrain_spritesheet.get_sprite(96, 200, self.width, self.height)
...
class Ground1(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.terrain_spritesheet.get_sprite(950, 700, self.width, self.height)
...
class Ground2(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.carpet_spritesheet.get_sprite(0, 0, self.width, self.height)
...
class Ground3(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.enemytile_spritesheet.get_sprite(0, 0, self.width, self.height)
...
class Attack(pygame.sprite.Sprite):
    ...
    def collide(self):
        ...
        if hits:
            ...
            pygame.mixer.Channel(2).play(pygame.mixer.Sound('soundtrack/goblin.mp3'))
            self.game.score += 1
